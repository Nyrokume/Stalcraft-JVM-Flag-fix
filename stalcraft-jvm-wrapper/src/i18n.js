...
const STRINGS = {
    en: {
        ...
        welcomeBody: 'Scans your hardware, builds a JVM profile, and injects optimized flags into STALZONE via IFEO (service.exe). Install once, restart the launcher, play normally.',
        welcomeLicense: 'This software is free and non-commercial. It may not be sold, resold, sublicensed, or distributed for money or other compensation. Redistribution is permitted only free of charge and with author attribution. By continuing you accept these terms.',
        welcomeAccept: 'I accept the license agreement',
        welcomeDontShow: "Don't show on startup",
        welcomeOk: 'Continue',
    ...
    ru: {
        ...
        welcomeBody: 'Определяет железо, собирает JVM-профиль и подставляет флаги в STALZONE через IFEO (service.exe). Установите хук, перезапустите лаунчер и играйте как обычно.',
        welcomeLicense: 'Программа бесплатная и некоммерческая. Запрещено продавать, перепродавать, сдавать в аренду или распространять за деньги и иное вознаграждение. Передача третьим лицам — только бесплатно и с указанием авторов. Продолжая, вы принимаете эти условия.',
        welcomeAccept: 'Я принимаю условия лицензии',
        welcomeDontShow: 'Не показывать при запуске',
        welcomeOk: 'Продолжить',
        footerAuthor: 'by Nyrokume.dev',
    },
};
